...
class WishListOnClick extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<WishListOnClick> createState() => _ItemOnClickState();
}

class _ItemOnClickState extends ConsumerState<WishListOnClick> {
...
int parseStock() {
  try {
    ...
    print('Error parsing productStock: $e');
    return 0; // Provide a default value or handle the error in a way that suits your use case.
  }
}
